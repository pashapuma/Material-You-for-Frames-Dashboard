    ...
    private fun getInternalAboutItems(): ArrayList<AboutItem> {
        ...
        if (shouldIncludeContributors()) {
			...
			items.add(
                AboutItem(
                    "PashaPuma",
                    string(R.string.pashapuma_description),
                    "https://raw.githubusercontent.com/pashapuma/Wallpapers_app/master/IMG_20191114_001904.jpg",
                    arrayListOf(
                        "Telegram" to "https://t.me/pashapuma_apps",
						"Page" to "https://play.google.com/store/apps/dev?id=6218933727384977479",
                        "Twitter" to "https://twitter.com/pashapuma1"
                    )
                )
            )
        }
